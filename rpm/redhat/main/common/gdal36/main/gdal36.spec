...
%{__mv} %{buildroot}/%{gdalinstdir}/lib64/python%{pyver}/site-packages/GDAL-%{version}-py*.egg-info/ %{buildroot}/%{python3_sitearch}/GDAL-%{version}-py%{pyver}.egg-info/
...
%{python3_sitearch}/GDAL-%{version}-py%{pyver}.egg-info/
